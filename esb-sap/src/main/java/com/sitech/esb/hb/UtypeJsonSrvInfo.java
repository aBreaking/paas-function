...
public class UtypeJsonSrvInfo extends SrvInfo implements java.io.Serializable {
	...
	/** default constructor */
	public UtypeJsonSrvInfo() {
		
	}
	
	//ȡ�÷����������Ϣ��
    public UtypeJsonSrvInfo(Long srvId, String srvName, String srvChName) {
